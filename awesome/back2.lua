...
{ "open terminal", terminal }
                              ...
                              awful.screen.connect_for_each_screen(function(s)
                                  ...
                                  local my_margin_systray = wibox.widget {
                                  ...
                                  s.mywiboxbot= wibox({ y = 0, x = s.geometry.x + 30, stretch = false, type ="dock", ontop = true, screen = s,height = 23, width = s.geometry.width - 30, struts = { top = 30 }  })
                                  s.mywiboxbot:setup {
